$(document).ready(function() {
    ...
    $('.content-questions__title').click(function(event) {
        if($('.questions__content').hasClass('one')){
            $('.content-questions__title').not($(this)).removeClass('active');
            $('.content-aquestions__text').not($(this).next()).slideUp(300);
        }
...
var swiper = new Swiper(".our-blogs__swiper", {
    navigation: {
  ...
  var swiper = new Swiper(".you-may-also__swiper", {
    navigation: {
      nextEl: ".swiper-button-next",
      prevEl: ".swiper-button-prev",
    },
  ...
  var swiper = new Swiper(".detail-page__swiper", {
    navigation: {
      nextEl: ".swiper-button-next",
      prevEl: ".swiper-button-prev",
    },
